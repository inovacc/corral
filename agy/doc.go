...
//
// The Driver satisfies pkg/corral.Provider and registers itself ("agy",
// "antigravity") with the core host in init(); import pkg/agents/all (or this
// package) to make it available via corral.ProviderByName.
//
// Usage monitoring (corral.UsageReporter) is implemented as the real quota call
